      ...
      app.innerHTML = \`
        <form id="configForm">
          ...
          <div class="panel">
            ...
            <div class="grid" style="margin-top:16px;">
              <label>Telemetry endpoint URL<input type="text" name="famousReconEndpointUrl" value="\${esc(config.integrations.famousRecon.endpointUrl || '')}" placeholder="https://your-app.example.com/api/fleet/mesh-plugin-telemetry"></label>
              <label>Fleet org deployment key<input type="text" name="famousReconApiKey" value="\${esc(config.integrations.famousRecon.apiKey || '')}" placeholder="fk_..."></label>
